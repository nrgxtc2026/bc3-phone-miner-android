...
{
    uint32_t hash1[16*8] __attribute__ ((aligned (128)));
    uint32_t hash2[16*8] __attribute__ ((aligned (128)));
    keccak256_8x64_context ctx;

    keccak256_8x64_init( &ctx );
    keccak256_8x64_update( &ctx, input, 80 );
    keccak256_8x64_close( &ctx, hash1 );

    keccak256_8x64_init( &ctx );
    keccak256_8x64_update( &ctx, hash1, 32 );
    keccak256_8x64_close( &ctx, hash2 );

    keccak256_8x64_init( &ctx );
    keccak256_8x64_update( &ctx, hash2, 32 );
...
{
    uint32_t hash1[16*4] __attribute__ ((aligned (64)));
    uint32_t hash2[16*4] __attribute__ ((aligned (64)));
    keccak256_4x64_context ctx;

    keccak256_4x64_init( &ctx );
    keccak256_4x64_update( &ctx, input, 80 );
    keccak256_4x64_close( &ctx, hash1 );

    keccak256_4x64_init( &ctx );
    keccak256_4x64_update( &ctx, hash1, 32 );
    keccak256_4x64_close( &ctx, hash2 );

    keccak256_4x64_init( &ctx );
    keccak256_4x64_update( &ctx, hash2, 32 );
...
{
    sha3d256_2x64_fixed( state, input );
}
